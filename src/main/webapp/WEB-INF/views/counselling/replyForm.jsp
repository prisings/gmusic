...
<body>
	...
	<section>
		...
		<form action="replyinsert" method="post">
			<table>
				<tr>
					<th class="leftbar" colspan="2">관리자 메뉴</th>
				</tr>
				<tr>
					<td>
						<input type="text" name="id" value="${loginID}" readonly hidden="hidden">
					</td>
				</tr>
				<tr height="40">
				...
				<tr height="40">
					...
					<td>
						<textarea rows="10" cols="40" name="content" maxlength="2000"></textarea>
					</td>
				</tr>
				<tr>
					<td></td>
