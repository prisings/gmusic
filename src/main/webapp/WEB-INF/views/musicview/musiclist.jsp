...
<body>
	...
	<div align="center">
		...
		<c:if test="${pageMaker.prev && pageMaker.sPageNo>1}">
			<a href="musiclist${pageMaker.makeQuery(1)}">&#8666;</a>&nbsp; <!-- First -->
			<!-- "qna?currPage=1" -->
			<a href="musiclist${pageMaker.makeQuery(pageMaker.sPageNo-1)}">&#8636;</a>
			<!-- Prev -->
		</c:if>
		...
		<c:forEach var="i" begin="${pageMaker.sPageNo}" end="${pageMaker.ePageNo}">
			...
			<c:if test="${i!=pageMaker.cri.currPage}">
				<a href="musiclist${pageMaker.makeQuery(i)}">${i}</a>&nbsp;
			</c:if>
		...
		<c:if test="${pageMaker.next && pageMaker.ePageNo>0}">
			<a href="musiclist${pageMaker.makeQuery(pageMaker.ePageNo+1)}">&nbsp;&nbsp;&#8640;</a>&nbsp; <!-- Next -->
			<a href="musiclist${pageMaker.makeQuery(pageMaker.lastPageNo)}">&#8667;</a>&nbsp;&nbsp; <!-- Last -->
