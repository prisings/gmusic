...
<body>
	...
	<nav>
		<ul>
			...
			<li><a href="notice" style="color: #0b3f9a; font-size: 25px;">공지사항</a>
	...
	<section>
		...
		<form action="nupdate" method="post">
			<table>
				<tr>
					<th class="leftbar" colspan="2">${Apple.title}</th>
				</tr>
				<tr height="40">
					<td class="leftbar">No.</td>
					<td>
						<input type="text" name="seq" id="seq" readonly value="${Apple.seq}" style="border: none;">
					</td>
					<!-- disabled: value가 서버로 전송되지않음 , readonly: value가 서버로 전송됨 -->
				</tr>
				<tr height="40">
					<td class="leftbar">제목</td>
					<td>
						<input type="text" name="title" value="${Apple.title}" maxlength="100">
					</td>
				</tr>
				<tr height="40">
					<td class="leftbar">내용</td>
					<td>
						<textarea rows="10" cols="40" name="content" maxlength="2000">${Apple.content}</textarea>
					</td>
				</tr>
				<tr height="40">
					<td class="leftbar">작성일자</td>
					<td>${Apple.regdate}</td>
				</tr>
				<tr height="40">
					<td class="leftbar">조회수</td>
					<td>${Apple.count}</td>
				</tr>
				<tr height="40">
					<td></td>
